...
class Student {
  #yearBirth;
  #arrayScores;
  #arrayAttendance = new Array(25).fill("");

  constructor(firstName, lastName, yearBirth, arrayScores) {
    this.firstName = firstName;
    this.lastName = lastName;
    this.YearBirth = yearBirth;
    this.ArrayScore = arrayScores;
    // this.#arrayAttendance = new Array(25).fill("");
  }
  ...
  get ArrayScore() {
    if (this.#arrayScores.length === 0) return 0;
